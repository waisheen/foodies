...
class _CreatePromotionPageState extends State<CreatePromotionPage> {
  ...
  late DateTime startDate =  widget.promo == null ? DateTime.now() : widget.promo!.startDate;
  late DateTime endDate =  widget.promo == null ? DateTime.now() : widget.promo!.endDate;
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: const Text("Promotional Period:", 
                    ...
                    GestureDetector(
                      ...
                      child: SizedBox(
                      width: MediaQuery.of(context).size.width - 60,
                      child: Text("${dateFromDateTime(startDate)}  -  ${dateFromDateTime(endDate)}", 
    ...
    return Padding(
      ...
      child: Image(
        ...
        errorBuilder: (context, error, stackTrace) {
                  return Text((url == '' ? 
                    'No image uplaoded' : 'Image cannot be shown'),
